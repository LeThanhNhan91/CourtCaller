...
const HomePage = () => {
    ...
    const displayCourts = courts.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);
            ...
            <div className="search_bar">
                ...
                <div className="row booking_court_container">
                    {displayCourts.map((court, index) => (
                        <div className="booking_court_detail col-lg-3 col-md-4 col-sm-6" key={index}>
